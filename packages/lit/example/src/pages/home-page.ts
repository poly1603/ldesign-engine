...
export class HomePage extends LitElement {
  ...
  private increment() {
    ...
    this.engine.events.emit('counter:changed', { count: this.count })
  }
  ...
  private reset() {
    this.count = 0
    this.engine.state.set('count', this.count)
    this.engine.events.emit('counter:reset', { count: this.count })
  }
      ...
      <div class="home">
        ...
        <div class="counter">
          ...
          <div class="counter-buttons">
            <button class="btn-secondary" @click=${this.decrement}>-</button>
            <button class="btn-secondary" @click=${this.reset}>重置</button>
            <button class="btn-primary" @click=${this.increment}>+</button>
          </div>
        </div>
        ...
        <div class="features">
          <div class="feature">
            <h3>⚡️ Lit</h3>
            <p>使用 Lit 构建快速、轻量的 Web Components</p>
          </div>
          <div class="feature">
            <h3>🔧 插件系统</h3>
            <p>强大的插件系统，轻松扩展功能</p>
