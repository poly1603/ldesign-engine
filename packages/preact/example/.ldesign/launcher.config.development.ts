...
export default defineConfig({
  framework: { type: 'preact' },
  server: { host: '0.0.0.0', port: 5181, open: true, hmr: true, strictPort: false, cors: true },
  preview: { host: '0.0.0.0', port: 4181, strictPort: false, open: false },
