...
class DevToolsIntegration {
  constructor(options = {}) {
    this.logger = logger.getLogger("DevToolsIntegration");
    this.timelineEvents = [];
...
exports.DevToolsIntegration = DevToolsIntegration;
exports.createDevToolsIntegration = createDevToolsIntegration;
//# sourceMappingURL=devtools-integration.cjs.map
