...
class DragDirective extends directiveBase.DirectiveBase {
  constructor() {
    super({
      name: "drag",
  ...
  mounted(el, binding) {
    ...
    vueDirectiveAdapter.directiveUtils.storeData(el, "drag-handlers", handlers);
    vueDirectiveAdapter.directiveUtils.storeData(el, "drag-state", state);
    vueDirectiveAdapter.directiveUtils.storeData(el, "drag-handle", handle);
  ...
  cleanup(el) {
    const handlers = vueDirectiveAdapter.directiveUtils.getData(el, "drag-handlers");
    const handle = vueDirectiveAdapter.directiveUtils.getData(el, "drag-handle");
    const state = vueDirectiveAdapter.directiveUtils.getData(el, "drag-state");
    ...
    vueDirectiveAdapter.directiveUtils.removeData(el, "drag-handlers");
    vueDirectiveAdapter.directiveUtils.removeData(el, "drag-state");
    vueDirectiveAdapter.directiveUtils.removeData(el, "drag-handle");
...
const vDrag = vueDirectiveAdapter.defineDirective(new DragDirective());

exports.DragDirective = DragDirective;
exports.default = vDrag;
exports.vDrag = vDrag;
