...
class LazyDirective extends directiveBase.DirectiveBase {
  constructor() {
    super({
      name: "lazy",
  ...
  unmounted(el) {
    ...
    vueDirectiveAdapter.directiveUtils.removeData(el, "lazy-loaded");
    vueDirectiveAdapter.directiveUtils.removeData(el, "lazy-loading");
    vueDirectiveAdapter.directiveUtils.removeData(el, "lazy-error");
  ...
  setupElement(el, config) {
    ...
    vueDirectiveAdapter.directiveUtils.storeData(el, "lazy-loading", true);
  }
  loadElement(el, config, entry) {
    const isLoaded = vueDirectiveAdapter.directiveUtils.getData(el, "lazy-loaded");
    if (isLoaded)
      return;
    if (config.onEnter) {
    ...
    if (config.callback) {
      ...
      vueDirectiveAdapter.directiveUtils.storeData(el, "lazy-loaded", true);
  ...
  loadImage(img, config) {
    ...
    tempImg.onload = () => {
      ...
      vueDirectiveAdapter.directiveUtils.storeData(img, "lazy-loaded", true);
      vueDirectiveAdapter.directiveUtils.removeData(img, "lazy-loading");
    ...
    tempImg.onerror = (_event) => {
      ...
      vueDirectiveAdapter.directiveUtils.storeData(img, "lazy-error", true);
      vueDirectiveAdapter.directiveUtils.removeData(img, "lazy-loading");
...
const vLazy = vueDirectiveAdapter.defineDirective(new LazyDirective());

exports.LazyDirective = LazyDirective;
exports.default = vLazy;
exports.vLazy = vLazy;
