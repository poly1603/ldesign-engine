...
class InfiniteScrollDirective extends directiveBase.DirectiveBase {
  constructor() {
    super({
  ...
  mounted(el, binding) {
    ...
    vueDirectiveAdapter.directiveUtils.storeData(el, "infinite-scroll-handler", handleScroll);
    vueDirectiveAdapter.directiveUtils.storeData(el, "infinite-scroll-container", container);
    vueDirectiveAdapter.directiveUtils.storeData(el, "infinite-scroll-timeout", timeoutId);
  ...
  cleanup(el) {
    const handler = vueDirectiveAdapter.directiveUtils.getData(el, "infinite-scroll-handler");
    const container = vueDirectiveAdapter.directiveUtils.getData(el, "infinite-scroll-container");
    const timeout = vueDirectiveAdapter.directiveUtils.getData(el, "infinite-scroll-timeout");
    ...
    vueDirectiveAdapter.directiveUtils.removeData(el, "infinite-scroll-handler");
    vueDirectiveAdapter.directiveUtils.removeData(el, "infinite-scroll-container");
    vueDirectiveAdapter.directiveUtils.removeData(el, "infinite-scroll-timeout");
...
const vInfiniteScroll = vueDirectiveAdapter.defineDirective(new InfiniteScrollDirective());

exports.InfiniteScrollDirective = InfiniteScrollDirective;
exports.default = vInfiniteScroll;
exports.vInfiniteScroll = vInfiniteScroll;
//# sourceMappingURL=infinite-scroll.cjs.map
