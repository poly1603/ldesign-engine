...
const monitoringInterval: number | null = null
const benchmarkInterval: number | null = null
    ...
    <div class="section">
      ...
      <div class="performance-overview">
        ...
        <div class="performance-actions">
          ...
          <button class="btn btn-primary" :disabled="isBenchmarkRunning" @click="runBenchmark">
          ...
          <button class="btn btn-warning" @click="optimizePerformance">
        ...
        <div class="benchmark-controls">
          <div class="test-config">
            ...
            <div class="config-actions">
              ...
              <button class="btn btn-secondary" @click="resetBenchmark">
          ...
          <div v-if="isBenchmarkRunning" class="test-progress">
            <h3>测试进度</h3>
          ...
          <div v-else class="results-list">
            ...
            >
              ...
              <div class="result-metrics">
                <div class="metric-grid">
                  ...
                  <div class="metric-card">
                    ...
                    <div class="metric-value">
                      {{ result.metrics.avgThroughput }} ops/s
                    </div>
                  </div>
                  <div class="metric-card">
                    <div class="metric-name">
              ...
              <div class="result-actions">
                <button class="btn btn-sm btn-secondary" @click="viewResultDetails(result)">
                  <Eye class="btn-icon" />
                  查看详情
                </button>
                <button class="btn btn-sm btn-primary" @click="compareResult(result)">
                  <GitCompare class="btn-icon" />
                  对比
                </button>
                <button class="btn btn-sm btn-secondary" @click="exportResult(result)">
          ...
          <div class="bottleneck-list">
            ...
            >
              ...
              <div class="bottleneck-actions">
                <button class="btn btn-sm btn-primary" @click="applyOptimization(bottleneck)">
                  <Zap class="btn-icon" />
                  应用优化
                </button>
                <button class="btn btn-sm btn-secondary" @click="ignoreBottleneck(bottleneck)">
          ...
          <div class="resource-analysis">
            <div class="resource-charts">
              <div class="resource-chart">
                <h4>CPU 使用分布</h4>
                <div class="pie-chart">
                  <div class="pie-slice" :style="{ '--percentage': 45, '--color': '#3b82f6' }" />
                  <div class="pie-slice" :style="{ '--percentage': 30, '--color': '#10b981' }" />
                  <div class="pie-slice" :style="{ '--percentage': 25, '--color': '#f59e0b' }" />
                </div>
              ...
              <div class="resource-chart">
                <h4>内存使用分布</h4>
                <div class="pie-chart">
                  <div class="pie-slice" :style="{ '--percentage': 40, '--color': '#8b5cf6' }" />
                  <div class="pie-slice" :style="{ '--percentage': 35, '--color': '#06b6d4' }" />
                  <div class="pie-slice" :style="{ '--percentage': 25, '--color': '#84cc16' }" />
                </div>
                <div class="chart-legend">
                  <div class="legend-item">
                  ...
                  <div class="legend-item">
                    <div class="legend-color" style="background: #06b6d4;" />
                    <span>事件系统 (35%)</span>
                  </div>
                  <div class="legend-item">
                    <div class="legend-color" style="background: #84cc16;" />
                    <span>依赖注入 (25%)</span>
                  </div>
                </div>
              </div>
                ...
                <div class="detail-list">
                  <div class="detail-item">
                    ...
                    <div class="detail-bar">
                      <div class="detail-fill" style="width: 12%;" />
                    </div>
                  </div>
                  <div class="detail-item">
                    ...
                    <div class="detail-bar">
                      <div class="detail-fill" style="width: 18%;" />
                    </div>
                  </div>
                  <div class="detail-item">
                    ...
                    <div class="detail-bar">
                      <div class="detail-fill" style="width: 25%;" />
                    </div>
                  </div>
                  <div class="detail-item">
                    ...
                    <div class="detail-bar">
                      <div class="detail-fill" style="width: 15%;" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="detail-section">
                ...
                <div class="detail-list">
                  <div class="detail-item">
                    ...
                    <div class="detail-bar">
                      <div class="detail-fill" style="width: 45%;" />
                    </div>
                  </div>
                  <div class="detail-item">
                    ...
                    <div class="detail-bar">
                      <div class="detail-fill" style="width: 32%;" />
                    </div>
                  </div>
                  <div class="detail-item">
                    ...
                    <div class="detail-bar">
                      <div class="detail-fill" style="width: 28%;" />
                    </div>
                  </div>
                  <div class="detail-item">
          ...
          <div class="recommendations">
            ...
            >
              ...
              <div class="recommendation-actions">
                <button class="btn btn-sm btn-primary" @click="applyRecommendation(recommendation)">
                  <Play class="btn-icon" />
                  应用建议
                </button>
                <button class="btn btn-sm btn-secondary" @click="scheduleRecommendation(recommendation)">
                  <Calendar class="btn-icon" />
                  计划实施
                </button>
                <button class="btn btn-sm btn-warning" @click="dismissRecommendation(recommendation)">
                  <X class="btn-icon" />
                  忽略
                </button>
              </div>
