 ...
 * ***********************************
 */
import { shallowRef, ref, computed, watchEffect, onUnmounted } from 'vue';

class VirtualScroller {
  constructor(config = {}, logger) {
    this.logger = logger;
    this.items = shallowRef([]);
    this.scrollOffset = ref(0);
    this.clientSize = ref(0);
    this.scrollSize = ref(0);
...
export { ComponentLazyLoader, ResourcePreloader, VirtualScroller, createComponentLazyLoader, createResourcePreloader, useVirtualScroll };
